...
// be made to read "Mx. Roger Jingleheimer Schmidt". Then pass this new
// array of names to the callback, which should use Array.prototype.forEach
...
//   let answer = array.map( name => `Mx. ${name} Jingleheimer Schmidt`);
//   callback(answer);
// }
//   titleize(["Ed","Eric","Sean"], names => {
...
// First, let's make a few elephants so we have a small herd. Feel free to
// copy the code below, or to make your own with any attributes you like.
...
// an elephant parade. It should take a single elephant as an argument; this
// way, we can pass it as a callback to forEach when called on our herd. Make
// sure to store it as a property on the Elephant object. You can populate
// it with any console.log statement you want to build your parade
// (e.g. "_______ is trotting by!").
