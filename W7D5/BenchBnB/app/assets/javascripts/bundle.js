...
/******/ 	return __webpack_require__(__webpack_require__.s = "./frontend/bench_bnb_entry.jsx");
/******/ })
/************************************************************************/
/******/ ({
...
var signup = function signup(user) {
  return function (dispatch) {
    return _util_session_api_util_js__WEBPACK_IMPORTED_MODULE_0__["signup"](user).then(function (users) {
...
var login = function login(user) {
  return function (dispatch) {
    return _util_session_api_util_js__WEBPACK_IMPORTED_MODULE_0__["login"](user).then(function (users) {
      return dispatch(receiveCurrentUser(users));
    }, function (err) {
      return dispatch(receiveErrors(err.responseJSON));
    });
...
var logout = function logout() {
  return function (dispatch) {
    return _util_session_api_util_js__WEBPACK_IMPORTED_MODULE_0__["logout"]().then(function (user) {
...
/* harmony import */ var _util_session_api_util_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./util/session_api_util.js */ "./frontend/util/session_api_util.js");
...
/* harmony default export */ __webpack_exports__["default"] = (Object(redux__WEBPACK_IMPORTED_MODULE_0__["combineReducers"])({
  // benches,
  // reviews,
  usersReducer: _users_reducer__WEBPACK_IMPORTED_MODULE_1__["default"]
}));

/***/ }),

/***/ "./frontend/reducers/errors_reducers.js":
/*!**********************************************!*\
  !*** ./frontend/reducers/errors_reducers.js ***!
  \**********************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  switch (action.type) {
    case _actions_session_action__WEBPACK_IMPORTED_MODULE_0__["RECEIVE_SESSION_ERRORS"]:
